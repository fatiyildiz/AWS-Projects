...
frank                            Frank
jocelyne yildiz                  Jocelyne Yildiz
...
|----cfn-template.yml   # To be delivered by DevOps team (Cloudformation template)
|----app.py            # Given to the DevOps team (Python Flask Web Application)
|----templates
        |----index.html      # Given to the DevOps team (HTML template)
        |----add-update.html # Given to the DevOps team (HTML template)
        |----delete.html     # Given to the DevOps team (HTML template)
```
...
### At the end of the project, DevOps team will be able to;
