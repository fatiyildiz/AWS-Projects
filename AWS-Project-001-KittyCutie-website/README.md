...
|----static-web
        |----index.html  # Given to the DevOps team (HTML file)
        |----cat0.jpg    # Given to the DevOps team (image file)
        |----cat1.jpg    # Given to the DevOps team (image file)
        |----cat2.jpg    # Given to the DevOps team (image file)
```
...
- Customize the application by hard-coding your name instead of `devops_name` within `index.html`.
