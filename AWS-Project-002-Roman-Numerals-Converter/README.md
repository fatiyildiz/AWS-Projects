# AWS-Project-002-Roman-Numerals-Converter : Roman Numerals Converter Application (Python Flask) deployed on AWS EC2 with Cloudformation and AWS CLI
## Description
...
|----cli.sh            # To be delivered by DevOps (CLI commands)
...
|----app.py            # Given to the DevOps (Definition of the project)          
|----templates
        |----index.html  # Given to the DevOps (HTML template)
        |----result.html # Given to the DevOps (HTML template)
```

## Expected Outcome

![AWS-Project-002-Roman-Numerals-Converter](project-002-snapshot.png)
