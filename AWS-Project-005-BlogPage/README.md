...
In the architecture, you can configure your infrastructure using the followings,
  ...
  - The Launch Template should be configured to;
    ...
    - Instance launched should be tagged `AWS Web Server`
...
```text
web_server_blog_proj (folder)
|
|----Readme.md               # Given to the DevOps team (Definition of the project)
|----src (folder)            # Given to the DevOps team (Django Application's )
...
- Step 5: Download or clone project definition from `frankyildiz` repo on Github 
